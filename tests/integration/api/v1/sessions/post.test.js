...
describe("POST /api/v1/sessions", () => {
  describe("Anonnymous user", () => {
    ...
    test("With correct `email` and correct `password`", async () => {
      ...
      const actualLifetimeMilliseconds = expiresAt - createdAt;
      const lifetimeDifferenceInMilliseconds =
        session.EXPIRATION_IN_MILLISECONDS - actualLifetimeMilliseconds;

      expect(lifetimeDifferenceInMilliseconds).toBeLessThanOrEqual(5_000);
