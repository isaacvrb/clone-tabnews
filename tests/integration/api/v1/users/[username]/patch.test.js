...
describe("PATCH /api/v1/users/[username]", () => {
  ...
  describe("Privileged user", () => {
    test("With `update:user:others` targeting defaultUser", async () => {
      const privileged = await orchestrator.createUser();
      const activatedPrivileged = await orchestrator.activateUser(privileged);

      await orchestrator.addFeatureToUser(privileged, ["update:user:others"]);
